...
public class TouristOperationsController {
	...
	@GetMapping("/findAll")
	public ResponseEntity<?> displayAllTourists() throws Exception {
...
//		}
		System.out.println("TouristOperationsController.displayTouristById()");
		Tourist tourist = service.fetchTouristById(id);
		return new ResponseEntity<Tourist>(tourist, HttpStatus.OK);
	}
	...
	public ResponseEntity<String> ModifyTouristBudgetById(@PathVariable("id") Integer id,
			@PathVariable("hike") Double hikePercent) throws Exception {
